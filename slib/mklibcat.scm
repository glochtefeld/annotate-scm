  ...
  (call-with-output-file catpath
	...
	(display " " op) (write asp op) (newline op))
      ...
      (for-each
       write*
       (append
        `((schelog source (library ,(sub-vicinity "" "schelog") "schelog"))
          (portable-scheme-debugger source (library ,(sub-vicinity "" "psd") "psd-slib"))
          (jfilter source (library ,(sub-vicinity "" "jfilter") "jfilter")))
	(catalog:resolve
	 'library
         ;;(library-vicinity)
	 (cons
